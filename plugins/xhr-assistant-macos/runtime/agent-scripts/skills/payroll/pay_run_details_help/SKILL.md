...
Where supported, payroll admins can review department-filtered results, calculation details, manual pay component values, and approval context. Use this view to validate payroll output before approving or exporting payroll data.
