---
name: xhr-support-ticket
description: Submit an xHR support request or feature request ticket on the user's behalf.
---

# xHR Support Ticket

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/support_ticket/SKILL.md`.
