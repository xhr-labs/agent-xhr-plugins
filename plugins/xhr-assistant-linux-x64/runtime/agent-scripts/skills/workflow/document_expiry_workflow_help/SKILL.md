...
### Direct answer
In [Workflows]({{workflows_url}}), create a date-based workflow and select the **Document expiry** event. Use the document effective-to or expiry date as the reference date.
