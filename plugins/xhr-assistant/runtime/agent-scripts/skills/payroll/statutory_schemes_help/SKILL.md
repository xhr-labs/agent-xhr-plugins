...
### Direct answer
Payroll admins manage statutory scheme setup in Payroll where the statutory module is available. A statutory scheme can include scheme details, contribution types, statutory programs, eligibility rules, calculation bases, output lines, and assigned employees.
