...
### Direct answer
Workbench sprint planning supports a sprint lifecycle for project teams. Authorized users can create, edit, start, complete, or delete sprints where the project configuration allows it.
