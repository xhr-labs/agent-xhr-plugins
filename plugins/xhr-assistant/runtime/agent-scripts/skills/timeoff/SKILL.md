...
- `skills/timeoff/cancel_approved_leave_help/SKILL.md` — Guidance on cancelling already-approved leave.
- `skills/timeoff/request_time_off_help/SKILL.md` — General help on requesting time off.
- `skills/timeoff/maternity_leave_help/SKILL.md` — Policy guidance for maternity and paternity leave.
...
- `skills/timeoff/configure_time_off_help/SKILL.md` — Guidance on configuring time-off settings and rules.
- `skills/timeoff/timeoff_carryover_help/SKILL.md` — Guidance on leave carryover rules and expiration.
- `skills/timeoff/timeoff_retroactive_policy_help/SKILL.md` — Guidance on retroactive policy recalculation.
