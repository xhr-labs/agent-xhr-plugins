---
name: xhr-helpdesk
description: Answer xHR product FAQ and how-to questions: setup, support, compliance, subscription and billing, mobile app, Lumi AI, and integrations.
---

# xHR HelpDesk

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/helpdesk/SKILL.md`.
