---
name: xhr-company
description: Answer xHR company-level questions: company profile and basic info, organization structure, department lists, work locations, and company-wide statistics.
---

# xHR Company

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/company/SKILL.md`.
