---
name: xhr-forms
description: Handle xHR forms: creating and publishing forms, securing public links, managing versions, reviewing submissions, review forms, and employee onboarding forms.
---

# xHR Forms

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/forms/SKILL.md`.
