---
name: xhr-vdr
description: Handle xHR Virtual Data Rooms (VDR): data room management, files, sharing, access requests, stakeholders, activity analytics, and audit logs.
---

# xHR Virtual Data Room

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/vdr/SKILL.md`.
