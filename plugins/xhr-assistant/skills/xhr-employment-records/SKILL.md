---
name: xhr-employment-records
description: Handle xHR employment records: employment contracts, employee change records, contract attachments, activity logs, company decisions, permissions, and related workflows.
---

# xHR Employment Records

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/employment_records/SKILL.md`.
