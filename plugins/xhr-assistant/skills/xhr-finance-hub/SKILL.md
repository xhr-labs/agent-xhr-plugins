---
name: xhr-finance-hub
description: Handle xHR Finance Hub: financial dashboards, income and expense categories, burn rate per month, cash runway, multi-currency behavior, and finance reporting.
---

# xHR Finance Hub

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/finance_hub/SKILL.md`.
