---
name: xhr-calendar
description: Handle xHR calendar booking and appointments: scheduling, share links, Google Calendar integration, permissions, public holidays, and holiday calendars.
---

# xHR Calendar

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/calendar/SKILL.md`.
