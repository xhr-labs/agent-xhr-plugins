---
name: xhr-document-generator
description: Generate xHR employee documents from DOCX templates: employee-data merging, previews, template versions, and DOCX or PDF exports.
---

# xHR Document Generator

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/document_generator/SKILL.md`.
