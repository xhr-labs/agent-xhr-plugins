---
name: xhr-workflow
description: Handle xHR workflows and automation: workflow building, date-based automation, Approval Hub approvals, Task Hub tasks, form tasks, document-expiry automation, and workflow events.
---

# xHR Workflow

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/workflow/SKILL.md`.
