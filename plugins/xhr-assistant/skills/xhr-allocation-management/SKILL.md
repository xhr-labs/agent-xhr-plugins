---
name: xhr-allocation-management
description: Handle xHR project allocation planning, monthly allocation lists, allocation dashboards (summary, utilization, allocation by line, timesheet sections), resource and project allocation reports, timesheet variance, and allocation integrations.
---

# xHR Allocation Management

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/allocation_management/SKILL.md`.
