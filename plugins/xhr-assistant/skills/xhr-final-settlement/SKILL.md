---
name: xhr-final-settlement
description: Explain xHR end-of-employment final settlement: app overview, settlement process, and permissions.
---

# xHR Final Settlement

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/final_settlement/SKILL.md`.
