...
description: Propose and confirm People report filters, then fetch and present every Workforce Structure widget shown in the People Reports tab, including six-month trends, structure breakdowns, movement tables and charts, offboarding, and employee type by department.
side_effect: read
---
...
### Answer objective
Fetch the complete presentation model rendered by the [People Reports tab]({{people_reports_url}}).
