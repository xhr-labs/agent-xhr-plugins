...
### Direct answer
1. Open [Forms]({{forms_url}}) and publish the form.
...
5. Regenerating creates a new active link using the saved security settings.
6. Use **Unpublish** when the form should no longer be publicly accessible.

The public access token is carried securely in the link fragment. Do not copy or expose the token separately.
