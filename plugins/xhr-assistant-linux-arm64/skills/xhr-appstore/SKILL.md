---
name: xhr-appstore
description: Answer xHR App Store questions: installing apps, managing installed apps, building your own apps, and app marketplace FAQs.
---

# xHR App Store

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/appstore/SKILL.md`.
