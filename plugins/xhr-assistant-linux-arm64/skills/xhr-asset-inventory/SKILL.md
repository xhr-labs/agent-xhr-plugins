---
name: xhr-asset-inventory
description: Handle xHR asset inventory: employee assets, asset requests and approvals, asset lifecycle, asset register export, bundles, vendors, and categories.
---

# xHR Asset Inventory

1. Call the bundled `xhr-assistant` MCP server's `read` tool with `skills/asset_inventory/SKILL.md`.
